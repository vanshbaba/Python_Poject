...
class engine(object):
    ...
    def play(self):
        ...
        while current_scene != last_scene:
            ...
            # be sure to print out the las scene
            current_scene.enter()
class death(scene):
...
class centralcorridor(scene):
    def enter(self):
        print(dedent("""
        The Gothons of planet percal #25 have invaded your ship and destoyed your entire crew.
        You are the last surviving memeber and your last mission is to get the neutron destruct bomb from the weapons armory, put it in the bridge, and blow the ship up after getting into an escape pod.
        ...
        if action == "shoot!":
            ...
            Your laser hits his costume but misses him entirely. This completely ruins his brand new costume his mother bought him, which makes him fly into an insane rage and blast you repeatedly in the face until you are dead. Then he eats you."""))
            return "death"
        elif action =="dodge!":
...
class laserweaponarmory(scene):
    def enter(self):
        print(dedent("""You do a dive roll into the Weapon Armory, crouch and scan the room for more Gothons that might be hiding. It's dead quiet, too quiet. You stand up and run to the far side of the room and find the neutron bomb in its container. There's a keypad lock on the box and you need the code to get the bomb out. If you get the code wrong times then the lock closes forever and you can't get the bomb. The code is 3 digits.
        """))
